...
class Character(Base):
    ...
    mass       : Mapped[str | None] = mapped_column(String, nullable=True)
    hair_color : Mapped[str | None] = mapped_column(String, nullable=True)
    skin_color : Mapped[str | None] = mapped_column(String, nullable=True)
    ...
    homeworld  : Mapped[str | None] = mapped_column(String, nullable=True)
    ...
    edited     : Mapped[str | None] = mapped_column(String, nullable=True)
...
class Starship(Base):
    ...
    cost_in_credits        : Mapped[str | None] = mapped_column(String, nullable=True)
    length                 : Mapped[str | None] = mapped_column(String, nullable=True)
    max_atmosphering_speed : Mapped[str | None] = mapped_column(String, nullable=True)
    crew                   : Mapped[str | None] = mapped_column(String, nullable=True)
    passengers             : Mapped[str | None] = mapped_column(String, nullable=True)
    cargo_capacity         : Mapped[str | None] = mapped_column(String, nullable=True)
    consumables            : Mapped[str | None] = mapped_column(String, nullable=True)
    hyperdrive_rating      : Mapped[str | None] = mapped_column(String, nullable=True)
    mglt                   : Mapped[str | None] = mapped_column(String, nullable=True)
    starship_class         : Mapped[str | None] = mapped_column(String, nullable=True)
