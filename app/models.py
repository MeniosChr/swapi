from sqlalchemy import Integer, Column, Table, Float, String, Date, DateTime, ForeignKey, JSON
...
class Character(Base):
    ...
    created : Mapped[DateTime | None] = mapped_column(DateTime, index=True, nullable=True)
    edited : Mapped[DateTime | None] = mapped_column(DateTime, index=True, nullable=True)
...
class Film(Base):
    ...
    release_date : Mapped[Date | None] = mapped_column(Date, index=True, nullable=True)
    characters : Mapped[list["Character"]] = relationship("Character", secondary = character_films, back_populates="films")
    planets : Mapped[str | None] = mapped_column(String, index=True, nullable=True)
...
class Starship(Base):
    ...
    hyperdrive_rating : Mapped[float | None] = mapped_column(Float, index=True, nullable=True)
